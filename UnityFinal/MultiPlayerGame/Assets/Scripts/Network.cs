...
public class Network : MonoBehaviour {
    ...
    {
        socket.Emit("sendScore", ScoreToJson(score));
    }

    public static JSONObject ScoreToJson(int score)
    {
        JSONObject jscore = new JSONObject(JSONObject.Type.OBJECT);
        jscore.AddField("score", score);
        return jscore;
    }
